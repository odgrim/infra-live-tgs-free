...
stack "bootstrap" {
  ...
  values = {
    ...
    aws_account_id = "339245257189"

    oidc_resource_prefix = "pipelines"

    github_org_name  = "odgrim"
    github_repo_name = "infra-live-tgs-free"
    deploy_branch = "main"
    ...
    // =========================================================================
    oidc_provider_import_arn = "arn:aws:iam::339245257189:oidc-provider/token.actions.githubusercontent.com"
    plan_iam_role_import_existing = true
    plan_iam_policy_import_arn = "arn:aws:iam::339245257189:policy/pipelines-plan"
    plan_iam_role_policy_attachment_import_arn = "pipelines-plan/arn:aws:iam::339245257189:policy/pipelines-plan"
    apply_iam_role_import_existing = true
    apply_iam_policy_import_arn = "arn:aws:iam::339245257189:policy/pipelines-apply"
    apply_iam_role_policy_attachment_import_arn = "pipelines-apply/arn:aws:iam::339245257189:policy/pipelines-apply"
    // =========================================================================
